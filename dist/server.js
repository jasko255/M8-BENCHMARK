...
var index_js_1 = __importDefault(require("./services/accommodation/index.js"));
var index_js_2 = __importDefault(require("./services/user/index.js"));
var port = process.env.PORT;
var mongoConnection = process.env.MONGO_CONNECTION_STRING;
var server = (0, express_1.default)();
server.use((0, cors_1.default)());
server.use(express_1.default.json());
server.use('/accommodation', index_js_1.default);
server.use('/users', index_js_2.default);
