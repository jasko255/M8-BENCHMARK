...
var generateJWT = function (payload) {
    return new Promise(function (resolve, reject) {
        return jsonwebtoken_1.default.sign(payload, process.env.JWT_SECRET, { expiresIn: '2w' }, function (err, token) {
            if (err)
                reject(err);
            resolve(token);
        });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, generateJWT({ _id: user._id, role: user.role })
